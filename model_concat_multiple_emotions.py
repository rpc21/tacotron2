...
class Decoder(nn.Module):
    def __init__(self, hparams):
        ...
        self.attention_rnn = nn.LSTMCell(
            hparams.prenet_dim + hparams.latent_out_dim + hparams.encoder_embedding_dim,
...
class Tacotron2(nn.Module):
    ...
    def parse_batch(self, batch):
        text_padded, input_lengths, mel_padded, gate_padded, output_lengths, labels = batch
    ...
    def forward(self, inputs):
        text_inputs, text_lengths, mels, max_len, output_lengths, labels = inputs
